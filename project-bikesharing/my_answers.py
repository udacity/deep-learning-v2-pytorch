...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # T Calculate the hidden layer's contribution to the error
        ...
        delta_weights_h_o += output_error_term * hidden_outputs[:, None]  # Weight step (hidden to output)e
    ...
    def run(self, features):
        ...
        #### Implement the forward pass here ####
        # T Hidden layer - replace these values with the appropriate calculations.
